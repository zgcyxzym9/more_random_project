...
from game_core.player import Player, InferencePlayer
...
model = ActorCritic(155, 39).to(device=device)
model.load_state_dict(torch.load("./logs/2026-02-06_20-06-44/ppo_actor_critic.pt"))
