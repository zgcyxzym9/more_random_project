...
class WuShiZhiDi:
    ...
    on_play = (lambda s: GiveBuff("round_buff_atk", 1, s.get_corresponding_hero(), s.owner.heroes),)
...
class WuShiZhiLi:
    ...
    name = "武士之笠"
    level_req = 2
    on_play = (lambda s: GiveBuff("hp", 2, s.get_corresponding_hero(), [s.get_corresponding_hero()]), 
